...
class KategoriOutController extends Controller
{
    /**
    ...
    public function update(InsertKategoriRequest $insertKategoriRequest, UpdateKategoriRequest $updateKategoriRequest)
    {
        ...
        $emp = KategoriOut::find($requestUpdate['id']);
